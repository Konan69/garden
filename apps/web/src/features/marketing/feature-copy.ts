...
export const gardenFeatures: GardenFeature[] = [
  {
    ...
    helps:
      'Give every role one place to talk to agents, assign work, connect tools, approve risky actions, and compound good process across the workspace.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Design for one product mode: approachable defaults, advanced depth still reachable. Skills, permissions, and agent config compound so one person’s breakthrough becomes everyone’s baseline. The UI teaches in-flow instead of requiring workshops.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Open many contexts at once, switch without losing panel state, and keep humans oriented with a stable left rail plus contextual explorer.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Surface open work, recent activity, and connection health so someone can decide what to open next.',
  ...
  },
  {
    ...
    helps:
      'Talk to an agent, watch tool use live, attach documents, approve actions inline, and resume the same thread later.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Track status, owner (human or agent), comments, activity, and work products on the same card.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Review permission requests, mentions, blockers, and failed runs; approve once or adjust trust for next time.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Run digests, triage passes, QA sweeps, and reminders on cron, manual trigger, or webhook without creating issue cards.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Browse agents, edit instructions, assign skills, and set per-tool trust before work starts.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Author `SKILL.md` in-app, import from skills.sh, assign skills to agents, and load them during chats, task runs, and automations. The goal is one teammate’s playbook becoming default behavior for every agent.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Connect Gmail, Google Drive, Slack, GitHub, and Exa Search today; expose typed tools with honest risk classes.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Add persistent agents for new specialties, or spin ephemeral sub-agents scoped to a chat, issue run, or automation run.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Classify connector tools by risk, set grants, audit every call, and pause the agent until inbox or inline approval resolves.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Run code in Cloudflare Sandboxes, stream logs to chat, and share preview URLs when the agent stands up a service.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Invite teammates, manage roles (owner/admin/member), and keep each company’s agents and data isolated.',
    triggered:
      'User signs up (new workspace) or accepts an invitation to join an existing one.',
  },
  {
    id: 'memory',
    ...
    helps:
      'Let agents start with people, projects, and channels already mapped; approve or dismiss pending memory updates.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Slack-native assistant in channels, API/script triggers, and mobile-friendly approval for permission requests.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Tile two panels horizontally or vertically while keeping the same rail and explorer model.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Nudge users and agents when a skill matches role, connected tools, or current chat/task context. Part of the same skills bet, not a separate product surface.',
    triggered:
  ...
  },
  {
    ...
    helps:
      'Render safe HTML/SVG/chart artifacts inline with theme tokens and export rules.',
    triggered:
      'Deferred until document artifact loop is stable and product needs structured visuals beyond prose.',
  },
  {
    id: 'knowledge-graph',
    ...
    helps:
      'Answer “what touches this account?” or “who owns this doc?” across Gmail, Slack, GitHub, and internal work.',
    triggered:
      'Deferred until connector reliability and memory scope are proven in beta.',
  },
  {
    id: 'review-grid',
    name: 'Review Grid',
    ...
    helps:
      'Scan, compare, and approve agent outputs across tasks without opening each thread.',
    triggered:
      'Deferred — depends on document artifact maturity and workspace-level tabs.',
  },
]
