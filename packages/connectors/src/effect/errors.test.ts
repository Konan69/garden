...
import { ConnectorError, ConnectorRateLimitError } from './errors.ts'

describe('ConnectorError', () => {
  it.effect(
    'inherits shared connector error while preserving Effect tags',
    () =>
      Effect.gen(function* () {
        ...
        expect(Predicate.isTagged(failure, 'ConnectorRateLimitError')).toBe(
          true,
        )
